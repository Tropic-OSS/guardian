...
module.exports = {
  ...
  async execute(message: Message) {
    ...
    const consoleChannel = (await client.channels.fetch(
      client.config.consoleChannel,
    )) as TextChannel;
    ...
    const embed = new EmbedBuilder()
      ...
      .setAuthor({
        name: "Guardian",
        iconURL:
          "https://cdn.discordapp.com/avatars/1063626648399921170/60021a9282221d831512631d8e82b33d.png",
      })
      .addFields([
