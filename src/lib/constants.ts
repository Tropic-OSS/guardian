...
export const ACCEPTED_MEMBER_ROW = new ActionRowBuilder<ButtonBuilder>().addComponents(
	new ButtonBuilder().setCustomId(BUTTON_IDS.JOIN_THREAD).setStyle(3).setLabel('Join Thread').setEmoji('🚀')
);
